...
commodity_files = {
    ...
    'Bawang Putih Bonggol': 'Bawang Putih Bonggol.csv',
    'Beras Medium': 'Beras Medium.csv',
    'Beras Premium': 'Beras Premium.csv',
    'Cabai Merah Keriting': 'Cabai Merah Keriting.csv',
    'Cabai Rawit Merah': 'Cabai Rawit Merah.csv',
    'Daging Ayam Ras': 'Daging Ayam Ras.csv',
    'Daging Sapi Murni': 'Daging Sapi Murni.csv',
    'Gula Konsumsi': 'Gula Konsumsi.csv',
    'Minyak Goreng Curah': 'Minyak Goreng Curah.csv',
    'Minyak Goreng Kemasan Sederhana': 'Minyak Goreng Kemasan Sederhana.csv',
    'Telur Ayam Ras': 'Telur Ayam Ras.csv',
    'Tepung Terigu (Curah)': 'Tepung Terigu (Curah).csv'
}
